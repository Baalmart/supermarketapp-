                                ...
                                <div class="span3">
                                    <ul class="nav nav-pills nav-stacked">
                                        ...
                                        <li><a href="shop.html">T-Shirts</a></li>
                                                                ...
                                                                <div class="span2">
                                    <ul class="nav nav-pills nav-stacked">
                                        <li><a href="#">Lorem Consectetur</a></li>
                                    </ul>
                                    ...
                                    <ul class="nav nav-pills nav-stacked">
                                        <li><a href="#">Dapibus Feugiat</a></li>
                                    </ul>
                                    <ul class="nav unstyled">
                                        <li><a href="#">Evening Tops</a></li>
                                        <li><a href="#">Shirts &amp; Blouses</a></li>
            ...
            <div class="span3">
                <div class="cart-container" id="cartContainer">
                    ...
                    <div class="open-panel">
                            ...
                            <div class="desc">
                                <strong><a href="product.html">Consectetur Vel Ac Feugiat</a></strong>
                            ...
                            <div class="desc">
                                <strong><a href="product.html">Ipsum Vel Vulputate Duis Eros Metus</a></strong>
                                <span class="light-clr qty">
                                    Qty: 1
                                    &nbsp;
                                    <a href="#" class="icon-remove-sign" title="Remove Item"></a>
                            ...
                            <div class="desc">
                                <strong><a href="product.html">Lorem Sit Adipiscing Condimentum</a></strong>
                                <span class="light-clr qty">
                                    Qty: 1
                                    &nbsp;
                                    <a href="#" class="icon-remove-sign" title="Remove Item"></a>
